# MyShoppingListV2-AWS
AWS lambda function to copy MyShoppingListV2 RN app local data to cloud
...
## Install
Make sure you already install node v14.15.1, then run in the project root folder 
```
npm i
```

## Build
Make ts files compile into js files
```
npm run compile
```
...
```bash
aws cloudformation delete-stack --stack-name my-shopping-list-cloud
```
